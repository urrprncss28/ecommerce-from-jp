...
if(isset($_GET['edit_products'])){
    ...
    if ($result && mysqli_num_rows($result) > 0) {
        ...
        if ($result_brand && mysqli_num_rows($result_brand) > 0) {
            ...
            echo '<p class="text-danger">No brand found</p>';
            $brand_title = "Unknown";
        }
    } else {
...
<div class="container mt-5">
    ...
    <form action="" method="post" enctype="multipart/form-data">
        ...
        <div class="form-outline w-50 m-auto mb-4">
            <label for="product_title" class="form-label mt-4">Product Name</label>
            <input type="text" id="product_title" value="<?php echo $product_title ?>" name="product_title" class="form-control" required="required">
        </div>

        <div class="form-outline w-50 m-auto mb-4">
            <label for="product_desc" class="form-label mt-4">Product Description</label>
        ...
        <div class="form-outline w-50 m-auto mb-4">
        <label for="product_category" class="form-label mt-4">Product Categories</label>
        ...
        <div class="form-outline w-50 m-auto mb-4">
        <label for="product_brands" class="form-label mt-4">Product Brands</label>
        ...
        <div class="form-outline w-50 m-auto mb-4">
            <label for="product_image1" class="form-label mt-5">Product Image1</label>
            <div class="d-flex">
