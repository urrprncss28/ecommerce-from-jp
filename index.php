...
if(!isset($_SESSION['username'])){
  ...
  echo "<li class='nav-item'>
  <!-- Existing Logout Link Modification -->
...
<!-- suspected bug around here -->
<!-- nandito ata ang bug para ma center ang mga text 
*kulang ata ng clossing div* -->
